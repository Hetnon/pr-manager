...
export default async function mergePr(repoPath, prNumber, strategy = 'squash') {
  ...
  // 1. Merge via GitHub API (gh enforces branch protection / required checks)
  ...
  // 2. Sync remote tracking refs + prune the deleted branch
