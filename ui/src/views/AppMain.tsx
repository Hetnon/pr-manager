...
// data layer (PR fetch + both analyses) lives in AnalysisProvider (mounted in
// MainPage, above this), so checks run regardless of which tab is open and
// switching never re-runs them.
